...
import { UserProfile } from '@/lib/interfaces/user'; // <-- Type của bạn
import { UserPlus, UserX } from 'lucide-react';
import { useRouter } from 'next/navigation';
// import { useUpdateProfile } from '@/hooks/user/useUser'; // Giả sử bạn có hook này
...
export function UserProfileActions({
  ...
  const renderActionButtons = () => {
    if (!isLoggedIn && user.userProfileType === 'PUBLIC') {
      return (
